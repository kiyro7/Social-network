...
/*
todo: кнопки для перехода туда сюда или текст-ссылка
todo: (с юзера на страницу новостей друзей и на страницу со списком друзей)
todo: (с админ панели на юзеров)
todo: (в лайауте по идее кнопку "админка", которая на список юзеров)

сделать расположение кнопки и текста на admin/users как на admin/news
*/